...
export const ProductCard = ({product, unitsProduct, setUnits, units, imgSize})=>{
    
    // si imgSize aun no existe cargo 100
    // imgSize = imgSize ? imgSize : 100;

    return (
        <div className={`shadow-component bg-[#FFC39E] relative duration-500 ease-in-out hover:scale-105 p-4 m-4 rounded-2xl `}
        ...
        >
            ...
            <section className="product-card-container grid rounded-lg ">
                ...
                <figure>
                    <img className="product-card--img rounded-lg min-h-52" src={product.img.url1} alt={product.img.alt} width={100 + '%;'} 
                    height={100 + '%;'} />
                </figure>
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="40" height="42" fill="currentColor" className="bi bi-bookmark-heart-fill" viewBox="0 0 16 16">
